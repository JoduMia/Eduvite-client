    ...
    <footer className="p-4 sm:p-6 bg-[#f1e5e5] dark:bg-[#020835] shadow-lg">
      <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
          <a href="https://Eduvite.com/" className="flex items-center">
            <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-8" alt="Eduvite Logo"/>
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Eduvite</span>
          </a>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
          <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">UGC Convocation</h2>
            <ul className="text-gray-600 dark:text-gray-400">
              <li className="mb-4">
                <a href="https://Eduvite.com/" className="hover:underline">Eduvite</a>
              </li>
              <li>
                <a href="/" className="hover:underline">Alumnai</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="text-gray-600 dark:text-gray-400">
              <li className="mb-4">
                <a href="https://github.com/themesberg/Eduvite" className="hover:underline ">Debate club</a>
              </li>
              <li>
                <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Charity trust</a>
              </li>
            </ul>
          </div>
          <div>
      ...
      <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8"/>
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://Eduvite.com/" className="hover:underline">Eduvite</a>. All Rights Reserved.
          </span>
